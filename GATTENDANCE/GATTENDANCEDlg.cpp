...
void CGATTENDANCEDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CGATTENDANCEDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
// CGATTENDANCEDlg 消息处理程序

BOOL CGATTENDANCEDlg::OnInitDialog()
{
...
void CGATTENDANCEDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CGATTENDANCEDlg::OnQueryDragIcon()
{
